        ...
        <div className="pt-24 md:pt-32 pb-20">
            <article className="section-container">
                ...
                <header className="max-w-3xl mb-16">
                    ...
                    <p className="text-neutral-400 text-lg mb-4">{caseStudy.company}</p>
                        ...
                        <div className="space-y-4">
                            {caseStudy.process.map((step, index) => (
                                <div key={index} className="flex gap-4 items-start">
                                    <div className="w-8 h-8 bg-neutral-800 rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold text-accent-400">
                                        {index + 1}
                                    </div>
                    ...
                    <section className="pt-8 border-t border-neutral-800">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {caseStudy.tags.map((tag, index) => (
                                <span
                                    key={index}
                                    className="px-3 py-1.5 bg-neutral-800/50 text-neutral-300 text-sm rounded-lg"
                                >
                                    {tag}
                                </span>
                            ))}
                ...
                {/* Next Steps */}
                <div className="max-w-3xl mt-16 glass-card p-8 text-center">
