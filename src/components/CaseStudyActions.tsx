...
export default function CaseStudyActions({ articleUrl, title }: CaseStudyActionsProps) {
    ...
    return (
        <div className="flex flex-wrap gap-4 mt-8 pt-8 border-t border-neutral-800">
            {articleUrl && (
                <a
                    href={articleUrl}
                    target="_blank"
            ...
            <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-neutral-800 hover:bg-neutral-700 text-white font-medium rounded-lg transition-colors border border-neutral-700"
            >
                {copied ? (
                    <>
